...
Then(/^I should see my fileroom summary with copied folder listed$/) do
  within_frame('content') do
    ...
    within(find('tr', :text => $data['folder1'])) {find('.action-icon')}
  end
end
...
Then(/^I should see my fileroom summary with copied document listed$/) do
  within_frame('content') do
    ...
    within(find('tr', :text => $data['placeholder7'])) {find('.action-icon')}
  end
end
...
Then(/^I should see my fileroom summary with copied placeholder listed$/) do
  within_frame('content') do
    ...
    within(find('tr', :text => $replaceddoc1title)) {find('.action-icon')}
    end
end


And(/^I click on Fileroom2 in left pane$/) do
